<template>
  ...
  <a-card title="增加xml-activity"></a-card>
</template>

<script lang="ts">
import { ref, defineComponent, computed, reactive, UnwrapRef } from 'vue'
import { getUUID, editFileName, editFileContentAssetsName, editClassFileName, addXml } from '../../../script/confuse'
import { addXml } from '../../../script/append'

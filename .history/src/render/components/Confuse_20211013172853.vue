<template>
  ...
  <a-drawer title="操作记录" placement="left" :closable="false" width="500px" v-model:visible="visible">
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const formState: UnwrapRef<FormState> = reactive({
      ...
      festPath: '/Users/yaohui/Downloads/HummerVpn/app/manifests'
    });
    ...
    const addXML = function () {
      addXmlWithActivity(formState.xmlFilePath, formState.addXmlActivityPath, formState.packageInfo, formState.festPath)
    }
    return {
      confuse,
      reBack,

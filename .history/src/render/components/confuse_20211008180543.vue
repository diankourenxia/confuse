...
<script lang="ts">
import { ref, defineComponent, computed, defineComponent, reactive, UnwrapRef } from 'vue'
import { getUUID, editFileName, editFileContentAssetsName } from '../../../script/confuse.ts'
export default defineComponent({
  ...
  setup: () => {
    ...
    const reBack = function () {
      window.fs.readdir(formState.assetsfilePath)
      console.log(a)

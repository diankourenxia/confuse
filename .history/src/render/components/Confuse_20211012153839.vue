<template>
  <a-card title="混淆 - 静态资源" type="inner" style="min-width:500px;width:100%;max-width:999px;margin:auto">
    <template #extra>
  ...
  <a-card title="混淆 - 类" type="inner" style="width:999px;margin:auto" headStyle=>
    <template #extra>
